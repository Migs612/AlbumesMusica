...
<div class="max-w-md mx-auto glass rounded-2xl p-8 mt-10 border border-white/10">
    <div class="text-center mb-8">
        <h2 class="text-3xl font-bold font-unbounded mb-2">Crear Cuenta</h2>
        <p class="text-gray-400">Únete a la comunidad de CrateCloud</p>
    </div>
    ...
    <form action="index.php?p=registro" method="POST" class="space-y-6">
        <div>
            <label class="block text-gray-300 text-sm font-bold mb-2" for="nombre">Nombre Completo</label>
            <div class="relative">
                <i class="ri-user-line absolute left-3 top-3 text-gray-500"></i>
                <input class="w-full bg-black/20 border border-white/10 rounded-lg py-3 px-4 pl-10 text-white focus:outline-none focus:border-purple-500 focus:ring-1 focus:ring-purple-500 transition-all" 
                       id="nombre" name="nombre" type="text" placeholder="Tu nombre" required>
            </div>
        </div>
        ...
        <div class="text-center mt-6">
            <p class="text-gray-400 text-sm">¿Ya tienes cuenta?</p>
            <a class="text-purple-400 hover:text-purple-300 font-bold text-sm" href="index.php?p=login">
                Inicia sesión aquí
            </a>
        </div>
    </form>
